CREATE TABLE _unused_MONITOR_QUERYSTAT
( 
...
sql_handle varbinary    NULL  
)  ON [PS__MONITOR_QUERYSTAT__REG_DT]
GO
CREATE clustered INDEX CIDX__MONITOR_QUERYSTAT__REG_DT ON _unused_MONITOR_QUERYSTAT ([reg_dt] ASC, [objectname] ASC , [dbname] ASC  ) ON [PS__MONITOR_QUERYSTAT__REG_DT] 
GO
ALTER TABLE _unused_MONITOR_QUERYSTAT ADD CONSTRAINT PK__MONITOR_SYSPROCESS__RET_DT_SEQ_NO primary key nonclustered ([reg_dt] ASC, [seq_no] ASC  ) ON [PS__MONITOR_QUERYSTAT__REG_DT] 
GO
