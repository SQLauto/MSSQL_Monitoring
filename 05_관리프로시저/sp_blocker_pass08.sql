...
GO
create procedure dbo.sp_blocker_pss08 (@latch int = 0, @fast int = 1, @appname sysname='PSSDIAG')
as 
--version 18 -- 2005 UNRELEASED
...
begin
   set @time2 = getdate()
   print ''
   print '9.0 Start time: ' + convert(varchar(26), @time, 121) + ' ' + convert(varchar(12), datediff(ms,@time,@time2))
